...
makeGetOp('customer','createdAt,objectId,uid,name,treePath,parentId,tel,custTypeId,custType,province,provinceId,city,cityId,area,areaId,address,contact,logo,sex,dealer_id,other,isInstall,wxAppKey,parentEme,parentMng,Authorize,onecar_bind,onecar_move,car_bind,car_move,subscribe');

...
class App extends React.Component {
    ...
    getUrl(){
        ...
        if(_user.customer.other&&_user.customer.other.url){
            location='http://w.wo365.net/wo365/action.html?intent=logout&action='+_user.customer.other.url+'&uid='+_user.customer.objectId+'&sellerId='+_user.employee.objectId+'&mobile='+this.state.seller.tel+'&title='+_user.customer.other.title;
        }else{

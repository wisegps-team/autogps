...
class App extends Component{
    ...
    render() {
        return (
            <ThemeProvider>
                <AppBar title={___.dealer} iconElementRight={<IconButton onClick={this.tip}><ContentAdd/></IconButton>}/>
...
function setShare(){
    var op={
        ...
        link: location.origin+'/?intent=logout&register=true&parentId='+_user.customer.objectId+'&custType=8&name='+encodeURIComponent(_user.customer.name), // 分享链接

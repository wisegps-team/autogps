window.___={
	...
	'user_sms_content':'尊敬的<%name%><%sex%>：已为您创建管理平台账号<%account%>，默认密码为<%pwd%>，请登录http://w.wo365.net或关注微信公众号“沃管车”管理。',
	'employee_sms_content':'尊敬的<%name%><%sex%>：卫网科技已为您创建管理平台账号，平台网址为http://wx.autogps.cn，登录账号为<%account%>，默认密码为<%pwd%>。',
	'sir':'先生',
	'lady':'小姐',
	'province':'省份',
	'city':'城市',

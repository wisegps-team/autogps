window.___={
	...
	'find_appid':'登录微信公众号，打开左边菜单栏》开发》基本配置，将AppID和AppSecret填入下框。',
	'set_url':'打开左边菜单栏》设置》公众号设置》功能设置标签页中，把“业务域名”，“JS接口安全域名”均设置为“<%domain%>”',
	'input_file_name':'打开左边菜单栏》设置》公众号设置》功能设置》网页授权域名》设置，将授权回调页面域名中中注意事项3的MP_????.txt文件全名填入下框',
	'save_wx_data':'打开左边菜单栏》设置》公众号设置》功能设置》网页授权域名》设置，将授权回调页面域名设置为“<%domain%>”（必须先保存本页信息之后才能设置“网页授权域名”）。',
	'wx_file_name':'凭证文件名',
	...
	'movecar_agent_register':'印刷合作伙伴注册',
	'movecar_customer_register':'扫码挪车客户注册',
	'wallet':'钱包',
	'order':'订单',
	'zhilianche':'智联车网',
	...
	'set':'设置',
	'confirm_remove_authorize': '确定取消选择用户的扫码挪车授权吗？'
}